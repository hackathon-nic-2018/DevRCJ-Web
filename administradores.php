          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                      <div class="box-body">
                        <form action="procesos/guardarServicio.php" method="post">
                          ...
                          if(mysqli_num_rows($registro)>0)
                          {
                            while($registro2 = mysqli_fetch_array($registro))
                            {
                              ...
                              echo '<tr>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <form action="edicionServicio.php" method="post">
                                    <input type="hidden" name="idservicio" value="'.$idServicio.'">
                                  <input type="hidden" name="descripcion" value="'.$descripcion.'">
                                    <input type="hidden" name="precio" value="'.$precio.'">
                                     <input type="hidden" name="estado" value="'.$estado.'">
                            <button name="editarServicio" type="submit" class="btn btn-info"><i class="fa fa-pencil-square-o"> Editar</i></button>
                                    </form>
                                  </div>

                                 <div class="col-md-6">
                                      <form action="procesos/recibirEliminacionServicio.php" method="post" onsubmit="return confirmation()">
                                       <input type="hidden" name="idservicio" value="'.$idServicio.'">
